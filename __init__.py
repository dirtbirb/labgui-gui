...
class GuiFrame(wx.Frame):
    ''' Simple three-section GUI with a left sidebar, bottom bar, and image '''
...
class RemotePanel(GuiPanel):
    ''' Remote sensor control '''

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

        lbl = wx.StaticText(self, label='Remote sensor')
        sensor_ip_lbl = wx.StaticText(self, label='Sensor IP')
        sensor_ip = wx.TextCtrl(self, style=wx.TE_PROCESS_ENTER)
        sensor_id_lbl = wx.StaticText(self, label='Sensor ID')
        sensor_id = wx.TextCtrl(self, value='0', style=wx.TE_PROCESS_ENTER)
...
class ViewPanel(GuiPanel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.MakeSizerAndFit(
            (lbl, wx.GBPosition(0, 0), span2),
            (open_btn, wx.GBPosition(1, 0), span1),
            (start_btn, wx.GBPosition(1, 1), span1),
            (lbl_source, wx.GBPosition(2, 0), span1, ALIGN_CENTER_RIGHT),
            (source, wx.GBPosition(2, 1), span1),
...
class ColorPanel(GuiPanel):
    ...
    def range_img(self, img):
        ''' Stretch dynamic range so max_px = 255 '''
        # TODO: Stretch to zero
        if self.range_btn:
...
class TargetPanel(GuiPanel):
    ...
    def __init__(self, *args, **kwargs):
        ...
        px_lbl = wx.StaticText(self, label=' ')
        px_x = wx.StaticText(self, size=wd1)
        px_y = wx.StaticText(self, size=wd1)
        reset_btn = wx.Button(
        ...
        self.MakeSizerAndFit(
            ...
            (target_lbl, wx.GBPosition(1, 0), span1, ALIGN_CENTER_RIGHT),
            (target, wx.GBPosition(1, 1), span2, wx.EXPAND),
            (orig_lbl, wx.GBPosition(2, 0), span1, ALIGN_CENTER_RIGHT),
            (x, wx.GBPosition(2, 1), span1, wx.EXPAND),
            (y, wx.GBPosition(2, 2), span1, wx.EXPAND),
            (px_lbl, wx.GBPosition(3, 0), span1, ALIGN_CENTER_RIGHT),
            (px_x, wx.GBPosition(3, 1), span1, ALIGN_CENTER_RIGHT),
            (px_y, wx.GBPosition(3, 2), span1, ALIGN_CENTER_RIGHT),
            (size_lbl, wx.GBPosition(4, 0), span1, ALIGN_CENTER_RIGHT),
